...
function playGame() {
    var gameSearch = selectedGameName.replace(/[:,^]/g, "").toLowerCase(); // Cleaned game name to search for
...
// Send user a text message after picking a game
function sendText(selectedGameName) {
    $.ajax({
        url: '/Home/SendTextMessage',
        type: "POST",
        data: {
